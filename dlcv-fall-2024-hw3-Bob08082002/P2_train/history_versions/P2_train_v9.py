...
from ImageCaptionModel_v9 import ImageCaptionModel
...
train_transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize(mean=[0.4850, 0.4560, 0.4060], std=[0.2290, 0.2240, 0.2250]) # mean and std of timm model config
])
