...
from ImageCaptionModel_v8 import ImageCaptionModel
...
#vision_encoder = "vit_huge_patch14_clip_336.laion2b_ft_in12k_in1k"
...
#    transforms.ToTensor(),
#    transforms.Normalize(mean=[0.4815, 0.4578, 0.4082], std=[0.2686, 0.2613, 0.2758]) # mean and std of timm model config
#])
train_transform = transforms.Compose([
    transforms.RandomHorizontalFlip(p=0.5),
...
optimizer = optim.Adam(model.parameters(), lr=0.004, weight_decay=1e-6)
