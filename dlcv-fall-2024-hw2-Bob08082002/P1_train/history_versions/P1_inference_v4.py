...
from P1_train.modules_v4 import UNet_conditional  # use empty __init__.py s.t. UNet_conditional can be imported
...
if __name__ == '__main__':
    ...
    num_classes = 20 
    num_each_dataset = 10
    model_path = 'checkpoint_model/P1/P1_model_ver4_1_epoch139.pth'
    # get $1
